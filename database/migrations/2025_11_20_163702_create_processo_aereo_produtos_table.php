...
return new class extends Migration
{
    public function up()
    {
        Schema::create('processo_aereo_produtos', function (Blueprint $table) {
            $table->id();

            $table->foreignId('produto_id')->constrained()->onDelete('cascade');
            $table->unsignedBigInteger('processo_aereo_id')->nullable();
            $table->foreign('processo_aereo_id')->references('id')->on('processo_aereos')->onDelete('cascade');
            ...
            $table->decimal('delivery_fee_brl', 15, 2)->nullable();
            $table->decimal('collect_fee', 15, 2)->nullable();
            $table->decimal('collect_fee_brl', 15, 2)->nullable();
            ...
            // Despesas específicas do transporte aéreo
    ...
    {
        Schema::dropIfExists('processo_aereo_produtos');
    }
};
