    ...
    <div class="card shadow-sm">
        <div class="card-header" style="background: var(--theme-gradient-primary);">
            <h3 class="card-title mb-0 text-white">
                <i class="fas fa-key me-2"></i>Listagem de Permissões
            </h3>
        </div>
        <div class="card-body">
            <form class="mb-4" id="formSearch" action="{{ route('permissao.index') }}" method="GET">
                <div class="row mb-3">
                    <div class="col-md-8 col-sm-12 mb-2 mb-md-0">
                        <div class="input-group">
                            ...
                            <button type="button" onclick="window.location.href='{{ route('permissao.index') }}'" 
                ...
                <div class="row">
                    <div class="col-12">
                        {{ $permissoes->appends(['paginacao' => $_GET['paginacao'] ?? 10])->links() }}
                    </div>
                </div>
            </form>
                    ...
                    <table id="grupoTable" class="table table-striped table-hover mb-0">
                        ...
                        <tbody>
                            @foreach ($permissoes as $permissao)
                                <tr @if ($permissao->deleted_at != null) class="table-danger" @endif>
                                    <td>{{ $permissao->id }}</td>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center" style="gap: 8px;">
                                            ...
                                            <form method="POST" action="{{ route('permissao.destroy', $permissao->id) }}"
