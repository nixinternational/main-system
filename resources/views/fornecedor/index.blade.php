...
@section('content')
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <form class="mb-4" id="formSearch" action="{{ route('fornecedor.index') }}" method="GET">
                <div class="row mb-3">
                    <div class="col-md-8 col-sm-12 mb-2 mb-md-0">
                        <div class="input-group">
                            ...
                            <input value="{{ $_GET['search'] ?? '' }}" type="text" id="search" name="search" 
                                class="form-control" placeholder="Buscar por nome, CNPJ..." 
                                aria-label="Buscar" aria-describedby="basic-addon1">
                            <button type="button" onclick="window.location.href='{{ route('fornecedor.index') }}'" 
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center" style="gap: 8px;">
                                            @if ($cliente->deleted_at == null)
                                                <a href="{{ route('fornecedor.edit', $cliente->id) }}" 
